...
<html lang="en">
	<head>
		...
		<title>Ready To Print Admin Panel</title>
		...
		<div class="login-box">
			...
			<div class="card card-outline card-primary">
			  	<div class="card-header text-center">
					...
					<img src="{{ asset('readytoprint.png') }}" alt="Ready To Print" class="brand-image img-circle elevation-3" style="opacity: .8; border-radius: unset;" width="120" height="auto">
			  	</div>
			  	<div class="card-body">
