...
//             if (collectingName) {
//                 appendMessage("You", `Name: ${userMessage}`, true);
//                 collectingName = false;
//                 chatbotInput.placeholder = "Type your phone number...";
//                 chatbotInput.value = "";
//             } else {
//                 appendMessage("You", `Phone Number: ${userMessage}`, true);
//                 // Here you can add logic to process the collected information.
//                 // For simplicity, let's just display a thank you message.
//                 setTimeout(() => appendMessage("ChatBot", "Thank you!"), 1000);
